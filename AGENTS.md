...
- `nullclaw-stack/` — our local deployment and operations wrapper around NullClaw
...
This root `AGENTS.md` applies to the wrapper stack, deployment flow, project docs, and future hosting/UI platform work.
...
- knowledge docs describing git, hooks, and scanner behavior
